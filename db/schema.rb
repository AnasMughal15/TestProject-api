...
ActiveRecord::Schema[7.2].define(version: 2026_02_21_200430) do
  ...
  create_table "sidekiq_job_trackers", force: :cascade do |t|
    t.string "job_id"
    t.string "job_class"
    t.string "queue"
    t.string "status"
    ...
    t.datetime "updated_at", null: false
    t.text "arguments"
    t.index ["job_class"], name: "index_sidekiq_job_trackers_on_job_class"
    t.index ["job_id"], name: "index_sidekiq_job_trackers_on_job_id", unique: true
    t.index ["status"], name: "index_sidekiq_job_trackers_on_status"
  end
  ...
  add_foreign_key "attachments", "bugs"
